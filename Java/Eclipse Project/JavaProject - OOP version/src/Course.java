...
public class Course implements Comparable {
	...
	private ArrayList<String> listOfEquivCourses;
	
	public ArrayList<String> getListOfEquivCourses() {
		return listOfEquivCourses;
	}

	public void setListOfEquivCourses(ArrayList<String> listOfEquivCourses) {
		this.listOfEquivCourses = listOfEquivCourses;
	}
	...
	public int compareTo(Object courseId) {
		...
		String aCourse = (String) courseId;
		if (this.listOfEquivCourses.contains(courseId)) {
			return 0;
		}
		return 0;
	}	
