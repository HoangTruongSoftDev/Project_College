...
return a}
function n(a){var b=typeof Symbol!="undefined"&&Symbol.iterator&&a[Symbol.iterator];if(b)return b.call(a);if(typeof a.length=="number")return{next:h(a)};throw Error(String(a)+" is not an iterable or ArrayLike");}
var ca=typeof Object.create=="function"?Object.create:function(a){function b(){}
b.prototype=a;return new b},p;
if(typeof Object.setPrototypeOf=="function")p=Object.setPrototypeOf;else{var q;a:{var da={a:!0},r={};try{r.__proto__=da;q=r.a;break a}catch(a){}q=!1}p=q?function(a,b){a.__proto__=b;if(a.__proto__!==b)throw new TypeError(a+" is not extensible");return a}:null}var t=p;
...
function Q(a){a=a===void 0?{}:a;M.call(this);this.i=[];this.h={};this.D=this.g=0;this.C=this.l=!1;this.u=[];this.A=this.F=!1;for(var b=n(na),c=b.next();!c.done;c=b.next())this.i[c.value]=[];this.j=0;this.N=a.timeout||1;this.o=ma;this.m=0;this.H=this.R.bind(this);this.M=this.T.bind(this);this.J=this.O.bind(this);this.K=this.P.bind(this);this.L=this.S.bind(this);if(b=!!window.requestIdleCallback&&!!window.cancelIdleCallback)b=P("EXPERIMENT_FLAGS",{}).disable_scheduler_requestIdleCallback,b=!(typeof b===
...
Q.prototype=ca(M.prototype);Q.prototype.constructor=Q;if(t)t(Q,M);else for(var R in M)if(R!="prototype")if(Object.defineProperties){var qa=Object.getOwnPropertyDescriptor(M,R);qa&&Object.defineProperty(Q,R,qa)}else Q[R]=M[R];function ra(a,b){var c=Date.now();S(b);b=Date.now()-c;a.l||(a.o-=b)}
